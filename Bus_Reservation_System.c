...
#include <stdlib.h>
#include <string.h>
char ch[20][200]={"Bengaluru-Mumbai","Bengaluru-Chennai","Bengaluru-Goa","Bengaluru-Trivandrum","Bengaluru-Mangaluru","Bengaluru-Mandya","Bengaluru-Tirupati","Bengaluru-Kochi","Bengaluru-Coimbatore"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
int main()
{
    ...
    system("cls");
    printf("\n\n\n");
   printf("====================================== KSRTC BUS RESERVATION SYSTEM ======================================\n\n\n");
